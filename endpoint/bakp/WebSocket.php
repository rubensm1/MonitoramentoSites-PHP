...
abstract class WebSocket {
    ...
    * @param WSMensagem    $wsMensagem     dados
    * @param resource $socket  socket para enviar
    * @return void  
    */
    protected function enviaDadoSocket($wsMensagem, $socket)
    {
        $this->logServidor("\nsend: " . json_encode($wsMensagem) . "\n");
        $mensagem = $this->mask(json_encode($wsMensagem));
    ...
    * @return void  
    */
    protected function enviaDadoMultSockets($wsMensagem, $sockets)
    {
        $this->logServidor("\nsend: " . json_encode($wsMensagem) . "\n");
        $mensagem = $this->mask(json_encode($wsMensagem));
